...
.PHONY: all check qualify-m1 amiga clean
...
$(BUILD)/amigopher: src/main.c src/gopher.c include/amigopher/amigopher.h include/amigopher/gopher.h | $(BUILD)
	$(CC) $(CFLAGS) -o $@ src/main.c src/gopher.c
...
amiga: | $(BUILD)
	$(AMIGA_CC) $(AMIGA_CFLAGS) -o $(BUILD)/AmiGopher src/main.c src/gopher.c
